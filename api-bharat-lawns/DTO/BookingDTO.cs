...
namespace api_bharat_lawns.ViewModel
{
    public class BookingDTO
    {
        ...
        [Required(ErrorMessage = "Please enter a valid Mobile NO")]
        [MobileNoAttribute(ErrorMessage = "Mobile No must be 10 digit")]
        public string MobileNo { get; set; }
        [RequiredNum(ErrorMessage = "Please enter Amount")]
        public decimal Amount { get; set; }
        [RequiredNum(ErrorMessage = "Please enter Advance")]
